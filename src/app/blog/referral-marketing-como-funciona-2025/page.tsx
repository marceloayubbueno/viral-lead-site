...
export default function ReferralMarketingComoFunciona2025Page() {
  const post = {
    title: "Referral Marketing: Como Funciona na Prática 2025 | Viral Lead",
    ...
    content: `# Referral Marketing: Como Funciona na Prática 2025
...
## Como Implementar Referral Marketing Hoje Mesmo
  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="referral marketing, marketing de indicação, vendas por indicação, programa de indicação, crescimento empresarial" />
